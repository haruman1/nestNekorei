...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Item not found in the cart' }),
    (0, swagger_1.ApiBody)({ type: update_cart_item_dto_1.UpdateCartItemDto }),
    (0, swagger_1.ApiParam)({ name: 'itemId', type: Number, description: 'Cart item ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of all items in the cart.' }),
