...
__decorate([
    ...
    (0, common_1.Post)(),
    openapi.ApiResponse({ status: 201, type: require("./entity/order.entity").OrderEntity }),
...
__decorate([
    ...
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("./entity/order.entity").OrderEntity] }),
    __metadata("design:type", Function),
