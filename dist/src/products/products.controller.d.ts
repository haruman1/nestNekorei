...
export declare class ProductsController {
    ...
    findAllProducts(): Promise<import("./entity").ProductResponse>;
    ...
    removeProduct(id: string): Promise<import("../Entity/edit.entity").EditEntity>;
    createCategory(createCategoryDto: CreateCategoryDto, req: Request & {
        user: JwtPayload;
    }): Promise<import("./entity").CategoriesResponse>;
    findCategoriesAll(): Promise<import("./entity").CategoriesResponse>;
