...
let ProductsController = class ProductsController {
    ...
    filterProducts(categoryId, minPrice, maxPrice, minRating) {
        return this.productsService.filterProducts(categoryId !== undefined ? String(categoryId) : undefined, minPrice, maxPrice, minRating);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Tidak terautentikasi.' }),
    openapi.ApiResponse({ status: 200, type: require("../Entity/edit.entity").EditEntity }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Produk tidak ditemukan.' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Tidak terautentikasi.' }),
    openapi.ApiResponse({ status: common_1.HttpStatus.NO_CONTENT, type: require("../Entity/edit.entity").EditEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
